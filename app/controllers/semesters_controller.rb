class SemestersController < ApplicationController
  ...
  # GET /semesters.json
  def index
    @semesters = Semester.chronological.paginate(:page => params[:page]).per_page(10)
  ...
  def show
    ...
    @user_positions = UserPosition.for_semester(@semester.id).paginate(:page => params[:page]).per_page(10)
